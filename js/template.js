(function($) { "use strict";
   ...
   $(window).scroll(function () { 
	...
	// About Ajax
			...
			$(window).load(function() {
			'use strict';		  
			  var loader = $('.expander-wrap2');
			if(typeof loader.html() == 'undefined'){
				$('<div class="expander-wrap2"><div id="expander-wrap2" class="container clearfix relative"><p class="cls-btn"><a class="close">X</a></p><div/></div></div>').css({opacity:0}).hide().insertAfter('.about');
				loader = $('.expander-wrap2');
			}
			$('.expander2').on('click', function(e){
				e.preventDefault();
				e.stopPropagation();
				var url = $(this).attr('href');
				...
				loader.slideUp(function(){
					$.get(url, function(data){
						var portfolioContainer = $('.about');
						var topPosition = portfolioContainer.offset().top;
						var bottomPosition = topPosition + portfolioContainer.height();
						$('html,body').delay(600).animate({ scrollTop: bottomPosition - -10}, 800);
						var container = $('#expander-wrap2>div', loader);
